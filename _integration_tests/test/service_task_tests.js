...
describe('Service Task - ', () => {
  ...
  it.only('should sucessfully execute an external ServiceTask via the ExternalTask API', async () => {

    const sampleWorker = await testFixtureProvider.resolveAsync('ExternalTaskSampleWorker');
    sampleWorker.start();
