    ...
    stage('Process Engine Tests') {
      steps {
        script {
          ...
          def db_storage_path_flow_node_instance = "--env process_engine__process_model_repository__storage=$db_storage_folder_path/processengine.sqlite";
          def db_storage_path_timer = "--env process_engine__process_model_repository__storage=$db_storage_folder_path/processengine.sqlite";
